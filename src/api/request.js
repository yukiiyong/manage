...
export const getAdminList = param => { return axios.get(api.base + api.adminList).then(res => res.data)}
...
export const addUser = param => { return axios.post(api.base + api.addUser).then(res => res.data)}
